//Conversion of specific to generic
//template <class T> add to every fuc start
//<T> node ani stack chya adhi add
//Push and pop replace int to T
//Main fuc madhi <int>obj add karyach
